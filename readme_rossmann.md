...
* O pior cenário consiste na soma das previsões diárias - a soma dos MAE da loja do período, o que corresponde ao faturamento de $157.112,39.

* O melhor cenário de previsão do faturamento consiste na soma das previsões diárias + a soma dos MAE da loja relativos as seis semanas, o que totaliza $180.262,30.
...
<p align = "left">
  <img width = "450" height = "300" src="images_read/gif_bot.gif">
</p>
